a: stack/stack.cpp main.cpp operations.cpp;
...
-Wstack-usage=8192 -pie -fPIE -Werror=vla stack/stack.cpp main.cpp operations.cpp create_bytecode.cpp -o stack.out
