a: stack/stack.cpp stack/main.cpp operations.cpp;
...
signed-integer-overflow,undefined,unreachable,vla-bound,vptr stack/stack.cpp stack/main.cpp operations.cpp -o stack.out